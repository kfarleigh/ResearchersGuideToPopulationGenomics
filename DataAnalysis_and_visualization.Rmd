...
```{r scatterplot viz, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_scatternocolor.png")
```

Now let's add some color. We will color the points by species. 

```{r scatterplot color, eval = FALSE}
...
```{r scatterplot color viz, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_scattercolor.png")
```
...
```{r scatterplot practice viz, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_scattercolor_practice.png")
```
...
```{r boxplot viz, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_boxplot_nocolor.png")
```
...
```{r boxplot viz practice, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_boxplot_color.png")
```
...
```{r multipanel viz, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_multipanel.png")
```
...
```{r multipanel viz practice, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/data_viz_multipanel2.png")
```
