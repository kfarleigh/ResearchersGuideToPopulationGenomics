...
```{r RGTPG logo, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("./imgs/RGTPG_logo.png")
```
...
### Citation {-}
Farleigh, K. (2026). *The researcher's guide to population genomics*. 
